 ...
 * @LastEditTime: 2023-06-20 18:17:33
 * @LastEditors: 陶帅星
 * @Description: 效果预览页面
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      const jsonData: VisualEditorModelValue =
        JSON.parse(localStorage.getItem(CacheEnum.PAGE_DATA_KEY) as string) || initJson; //预览页面初始化数据
